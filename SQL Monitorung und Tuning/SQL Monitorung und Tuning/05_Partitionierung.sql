...
--Seiten Zeilen--- 40 bis60%


--neustart Ram: 480

set statistics io, time on
select * from demodb..t2
 --CPU-Zeit = 640 ms, verstrichene Zeit = 4220 ms.  20000 Seiten 
...
set statistics io, time on
select * from demodb..t1
 --CPU-Zeit = 640 ms, verstrichene Zeit = 4220 ms.  20000 Seiten 

--_Seiten weniger  Dauer kürzer CPU weniger
--Ram:  evtl mehr aber nicht viel